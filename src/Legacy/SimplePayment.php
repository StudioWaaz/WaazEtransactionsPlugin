...
final class SimplePayment
{
    ...
    public function execute()
    {
        ...
        $this->etransactions->setShoppingCartTotal($this->order->getTotalQuantity());
        $this->etransactions->setBilling($this->buildBillingArray($this->order));

        $this->etransactions->validate();

        return $this->etransactions->executeRequest();
    }
    ...
    private function buildBillingArray(OrderInterface $order): array
    {
     ...
     * @return self
     */
    public function setCountryCodeFromAlpha2(string $countryCode): string
    {
